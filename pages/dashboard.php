                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div style="color: #1c2b23;" class="h5 mb-0 font-weight-bold">
                    ...
                    <div style="background-color: #49BF8A; border-radius: 10px;" class="col-auto p-1 mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
                        ...
                        <path fill="none" stroke="#295a44" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h12M6 4v16M6 4H5m13 0v16m0-16h1m-1 16H6m12 0h1M6 20H5M9 7h1v1H9zm5 0h1v1h-1zm-5 4h1v1H9zm5 0h1v1h-1zm-3 4h2a1 1 0 0 1 1 1v4h-4v-4a1 1 0 0 1 1-1" />
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div style="background-color: #49BF8A; border-radius: 10px;" class="col-auto p-1 mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0z" fill="none" />
                        <path fill="#165036" d="M13.07 10.41a5 5 0 0 0 0-5.82A3.4 3.4 0 0 1 15 4a3.5 3.5 0 0 1 0 7a3.4 3.4 0 0 1-1.93-.59M5.5 7.5A3.5 3.5 0 1 1 9 11a3.5 3.5 0 0 1-3.5-3.5m2 0A1.5 1.5 0 1 0 9 6a1.5 1.5 0 0 0-1.5 1.5M16 17v2H2v-2s0-4 7-4s7 4 7 4m-2 0c-.14-.78-1.33-2-5-2s-4.93 1.31-5 2m11.95-4A5.32 5.32 0 0 1 18 17v2h4v-2s0-3.63-6.06-4Z" />
                      </svg>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">ACTIVE INSTALLMENTS</div>
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">306</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                    ...
                    <div style="background-color: #49BF8A; border-radius: 10px;" class="col-auto p-1 mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0z" fill="none" />
                        <path fill="#165036" d="M3 6h18v12H3zm9 3a3 3 0 0 1 3 3a3 3 0 0 1-3 3a3 3 0 0 1-3-3a3 3 0 0 1 3-3M7 8a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2v-4a2 2 0 0 1-2-2z" />
                      </svg>
                    </div>
                  </div>
                </div>
